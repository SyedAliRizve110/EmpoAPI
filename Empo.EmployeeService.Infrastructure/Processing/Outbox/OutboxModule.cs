using Autofac;
using Empo.BuildingBlocks.Application.Events;
using Empo.BuildingBlocks.Application.Outbox;
using Empo.BuildingBlocks.Infrastructure;
using Empo.BuildingBlocks.Infrastructure.DomainEventsDispatching;
using Empo.EmployeeService.Infrastructure.Outbox;
